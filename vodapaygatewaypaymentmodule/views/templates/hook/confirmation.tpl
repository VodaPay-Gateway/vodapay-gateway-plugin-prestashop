...
<h3>{l s='Your order on %s is complete.' sprintf=$shopName mod='vodapaygatewaypaymentmodule'}</h3>
<p>
	<br />- {l s='Amount' mod='vodapaygatewaypaymentmodule'} : <span class="price"><strong>{$total|escape:'htmlall':'UTF-8'}</strong></span>
	<br />- {l s='Reference' mod='vodapaygatewaypaymentmodule'} : <span class="reference"><strong>{$reference|escape:'html':'UTF-8'}</strong></span>
	<br /><br />{l s='An email has been sent with this information.' mod='vodapaygatewaypaymentmodule'}
